...
function Home() {
    const [showAuthButtons, setShowAuthButtons] = useState(false); // State to manage the visibility of auth buttons

    const handleGetStarted = () => {
        setShowAuthButtons(true); // Show sign in and sign up buttons
    };
            ...
            <header style={styles.header}>
                ...
                {!showAuthButtons ? (
                    ...
                    <div style={styles.authButtons}>
                        <Link to="./signIn">
                        <button style={styles.authButton} onClick={() => alert('Sign In Clicked!')}>
                            Sign In
                        </button>
                        </Link>
                        <Link to={"./signUp"} >
                        <button style={styles.authButton} onClick={() => alert('Sign Up Clicked!')}>
                            Sign Up
                        </button>
                        </Link>
                    </div>
